...
public class FloatingModMenuService extends Service {
    ...
    int TEXT_COLOR = Color.parseColor("#FFFFFF"); // 82CAFD
    int TEXT_COLOR_2 = Color.parseColor("#FFFFFF");
    String NumberTxtColor = "#41c300";

    int BTN_COLOR = Color.parseColor("#00000000");
    ...
    private void initFloating() {
        ...
        mExpanded.setPadding(1, 10, 1, 10); // So borders would be visible
        ...
        gdMenuBody.setStroke(1, Color.parseColor("#ff0000")); // Set border
        mExpanded.setBackground(gdAnimation); // Apply GradientDrawable to it
        ...
        heading.setTextColor(TEXT_COLOR_2);
        ...
        gdMenuBody.setColor(MENU_FEATURE_BG_COLOR); // Set background color
        gdMenuBody.setStroke(1, Color.parseColor("#ff0000")); // Set border
        scrollView.setBackground(gdMenuBody);
        ...
        // **********  Hide/Kill button **********
        RelativeLayout.LayoutParams lParamsHideBtn = new RelativeLayout.LayoutParams(WRAP_CONTENT, dp(35));
        ...
        // ********** Close button **********
        RelativeLayout.LayoutParams lParamsCloseBtn = new RelativeLayout.LayoutParams(WRAP_CONTENT, dp(35));
        ...
        params.gravity = Gravity.CENTER; // 51
        params.x = 0; // 0
        params.y = 0; // 100
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                // starting menu
                // Comment the if-else code out except startService if you want to run the app and
                // test preferences
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                switch (motionEvent.getAction()) {
                    ...
                    case MotionEvent.ACTION_UP:
                        ...
                        // The check for Xdiff <10 && YDiff< 10 because sometime elements moves a
    ...
    private View TextField(final int featNum, final String featName, final boolean numOnly, final int maxValue) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                TextViewNote.setTextSize(13.0f);
    ...
    private View RadioButton(final int featNum, String featName, final String list) {
        ...
        for (int i = 0; i < lists.size(); i++) {
            ...
            Radioo.setTypeface(null, Typeface.BOLD);
            Radioo.setTextColor(Color.LTGRAY);
            Radioo.setTextSize(13.0f);
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP)
    ...
    public void startAnimation() {
        final int start = Color.parseColor("#dd000000");
        final int end = Color.parseColor("#ddcc0000");

        final ArgbEvaluator evaluator = new ArgbEvaluator();
        gdAnimation.setStroke(1, Color.parseColor("#ff0000")); // Set border
        ...
        if (EnableSounds()) {
            if (!delayed) {
                ...
                if (FXPlayer != null)
                    ...
                    FXPlayer.setVolume(setVol, setVol);
                FXPlayer.start();
    ...
    // Override our Start Command so the Service doesnt try to recreate itself when the App is
    // closed
