...
void *hack_thread(void *) {
    ...
    // Offset you want Target object of your Esp public class DestroyGameObject : MonoBehaviour private void Update() { }
    MSHookFunction((void *) getAbsoluteAddress("libil2cpp.so", 0x13C1C78), (void *) &_update,
                   (void **) &update);

    // Offset to Fix the Crash Problem
    // MSHookFunction((void *) getAbsoluteAddress("libil2cpp.so", 0x000000), (void *) &_ondestroy, (void **) &ondestroy);
