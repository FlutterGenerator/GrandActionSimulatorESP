...
Java_uk_lgl_modmenu_FloatingModMenuService_setTitleText(JNIEnv *env, jobject thiz, jobject obj) {
    setText(env, obj, OBFUSCATE("<b>Grand Action Simulator 1.8.0</b>"));
...
Java_uk_lgl_modmenu_FloatingModMenuService_setHeadingText(JNIEnv *env, jobject thiz, jobject obj) {
    setText(env, obj, OBFUSCATE("ESP<p style=\"color:red;\">Modder by tojik_proof_93</p>"));
...
Java_uk_lgl_modmenu_FloatingModMenuService_settingsList(JNIEnv *env, jobject activityObject) {
    ...
    const char *features[] = {
            "-1_Toggle_Save feature preferences", //-1 is checked on Preferences.java
            "-3_Toggle_Auto size vertically",
            "-1000_Toggle_True_Color Animation",
            "-2000_Toggle_Sounds",
            "-6_Button_<font color='red'>Close settings</font>",
            "ButtonLink_Youtube.com/@saveeditoronlinecom_https://youtube.com/@saveeditoronlinecom",
    };
